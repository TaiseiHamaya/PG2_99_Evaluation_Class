...
public:
	// ------------------operator------------------
	constexpr inline Vector2& operator=(const Vector2& vec) noexcept;
	constexpr inline Vector2& operator=(Vector2&& vec) noexcept;
...
inline constexpr Vector2::Vector2(const Vector2& vec) noexcept :
	x(vec.x),
	y(vec.y) {
}

inline constexpr Vector2::Vector2(Vector2&& vec) noexcept :
	x(std::move(vec.x)),
	y(std::move(vec.y)) {
}
